...
if ($_GET['sort'] == 'size') { 
	   ...
	   if ($_GET['order'] == 'descending') { $filesArray = array_reverse($filesArray); }
	}
...
// Hhelper Functions
function getFiles(){
         $dirname = '/home/csee1/rbirky1/www-data/read-write/fm/';
         $dir = '/home/csee1/rbirky1/www-data/read-write/fm/*';
         $files = array();
         $finfo = finfo_open(FILEINFO_MIME_TYPE);
         foreach (glob($dir) as $file){
           $n = basename($file);
           $t = date("M j, Y g:i a", filemtime($file));
           $m1 = finfo_file($finfo, $file);
           $m = getMime($m1);
           $s = filesize($file);
           $href = "./get-file.php?name=$n&amp;mime=$m1";
